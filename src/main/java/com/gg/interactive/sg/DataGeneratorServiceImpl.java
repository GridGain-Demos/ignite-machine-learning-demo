...
import com.gg.interactive.ConfigNodeClient;
import com.gg.interactive.sg.DatasetBuilder;
import com.gg.interactive.ConfigPipeLineSettings;
...
//     private IgniteCache<K, V> cache2;
	...
	public int generateLabeledRows(int rowCount)  // labeled = training data; row count  ignored for now, use properties file
	{
    	...
    	// true to write output CSV file
			...
			com.gg.interactive.ConfigPipeLineSettings.statusFileWriteMsg("dataset generator run, training data cache name: " 
