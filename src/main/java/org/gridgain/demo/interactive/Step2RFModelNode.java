...
//            		IgniteConfiguration cfg1 = ConfigNodeServers.getIgniteModelNodeConfiguration("RFMN");
    ...
    public static int preprocess () {
        ...
        try  {
            ...
            org.gridgain.demo.interactive.Step2RFModelNode.ONEHOT_ENCODER_PREPROCESSOR = new EncoderTrainer<Integer, Vector>()
            ...
            ConfigPipeLineSettings.statusFileWriteMsg("PreProcessor instanced: {" 
            			+ org.gridgain.demo.interactive.Step2RFModelNode.ONEHOT_ENCODER_PREPROCESSOR.toString() + "}");
    ...
    public static int train ()
    {
    	...
    	+ ConfigPipeLineSettings.DATA_SPLIT);
    	 ...
    	 try  {
             ...
             org.gridgain.demo.interactive.ConfigPipeLineSettings.statusFileWriteMsg("\n>>> Trained RF model, Revision: {" + 
            		 MODEL_CURRENT_VERSION_NUMBER + "}"
             		+  RF_MODELS[MODEL_CURRENT_VERSION_NUMBER].toString());
             org.gridgain.demo.interactive.ConfigPipeLineSettings.statusFileWriteMsg("Training time is " + (endTraining - startTraining) + " milliseconds");

           
             
             long endEvaluation = System.currentTimeMillis();
             org.gridgain.demo.interactive.ConfigPipeLineSettings.statusFileWriteMsg("Evaluation time is: " + (endEvaluation - endTraining) + " milliseconds");

             org.gridgain.demo.interactive.ConfigPipeLineSettings.setPredictiveModelReady();
            ...
            PROCESS_STAGE=2;
        	 ...
        	 org.gridgain.demo.interactive.ConfigPipeLineSettings.statusFileWriteMsg("Exception during Training process: " + e.getMessage());
         }
    ...
    public static int printModel()
    {
		...
		org.gridgain.demo.interactive.ConfigPipeLineSettings.statusFileWriteMsg(status);
 		return 0;
    ...
    public static String  updateModel(String newTransactionsCacheName)
    {
    	...
    	if(MODEL_CURRENT_VERSION_NUMBER < MODEL_VERSION_NUMBER_MAX)
    	{
    		...
    		RF_MODELS[MODEL_CURRENT_VERSION_NUMBER + 1 ] = 
    				...
    				xactionCache, 
    				org.gridgain.demo.interactive.Step2RFModelNode.ONEHOT_ENCODER_PREPROCESSOR);
